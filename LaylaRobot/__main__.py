...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="http://t.me/SerafallRobot?startgroup=true"),
    ],
    [
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *ꜱᴇʀᴀꜰᴀʟʟ*, a powerful group management bot built to help you manage your group easily.
